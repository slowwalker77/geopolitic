...
<div className="flex space-y-4">
  {/* 제목 */}
  <h2 className="text-blue-900 text-ms md:text-lg space-y-4 lg:text-xl font-bold">
...
<p className="text-lg md:text-base lg:text-lg" onClick={onToggle} style={{ cursor: 'pointer' }}>
  ...
  <div className="flex justify-end">
    <button onClick={onToggle} className="text-orange-800 text-ms md:text-lg lg:text-xl">
      {isExpanded ? '[접기]' : '[전문]'}
    </button>
  </div>
    </div>
